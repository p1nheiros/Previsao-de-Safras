...
const Page = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold">Resumo do Modelo</h1>
      ...
      <h1 className="text-2xl font-bold mt-4">Relatório de Classificação</h1>
      ...
      <div>
        <button onClick={handlePredict}>Obter Dados</button>
      </div>
    </div>
  );
};
